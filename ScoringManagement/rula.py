...
def rula_score(Body,gewicht = 1,statisch = False):
    ...
    if not elbogenR: oberarm_wertR = 1
        ...
        oberarm_wertR = 1
        if((140 - oberarmR) < 20 and elbogenR_Y < schulterR_Y):
            oberarm_wertR = 1
        elif((140- oberarmR) > 20 and elbogenR_Z < huefteR_Z and elbogenR_Y < schulterR_Y): #Arm ist nach hinten gestreckt
            oberarm_wertR = 2
        elif((140- oberarmR) > 20 and (140 - oberarmR) < 40 and elbogenR_Y < schulterR_Y) :
            oberarm_wertR = 2
        elif(elbogenR_Y > schulterR_Y):
            oberarm_wertR = 4
        else:
            oberarm_wertR = 3
    ...
    if not elbogenL: oberarm_wertL = 1
        ...
        oberarm_wertL = 1
        if((140 - oberarmL) < 20 and elbogenL_Y < schulterL_Y):
            oberarm_wertL = 1
        elif((140- oberarmL) > 20 and elbogenL_Z < huefteL_Z and elbogenL_Y < schulterL_Y): #Arm ist nach hinten gestreckt
            oberarm_wertL = 2
        elif((140- oberarmL) > 20 and (140 - oberarmL) < 40 and elbogenL_Y < schulterL_Y) :
            oberarm_wertL = 2
        elif(elbogenL_Y > schulterL_Y):
            oberarm_wertL = 4
        else:
            oberarm_wertL = 3
    ...
    if(not(handgelenkR) or not(elbogenR)): unterarm_wertR = 1
        ...
        unterarm_wertR = 1
        if unterarmR > 120 and unterarmR < 140:
            unterarm_wertR = 1
        else:
            unterarm_wertR = 2
        '''
    ...
    if(not(handgelenkL) or not(elbogenL)): unterarm_wertL = 1
        ...
        unterarm_wertL = 1
        if unterarmL > 120 and unterarmL < 140:
            unterarm_wertL = 1
        else:
            unterarm_wertL = 2
        '''
        if unterarmL < 60 :
            unterarm_wertL = 2
        elif unterarmL >= 60 and unterarmL <100: # 1 wenn zwischen 120 und 140
            unterarm_wertL = 1
        elif unterarmL >= 100 :
            unterarm_wertL =2
        '''
